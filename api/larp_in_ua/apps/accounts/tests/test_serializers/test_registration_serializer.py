...
from larp_in_ua.apps.accounts.api.v1.serializers.registration import RegistrationSerializer
from larp_in_ua.apps.accounts.exceptions import InvalidPasswordError
