...
Якщо ти рєеструвалася (чи рєеструвався) на щось з потоку "Діло", я нагадаю тобі про цей івент за пів-години до старту, але тобі треба буде протягом двадцяти хвилин підтвердити свою участь, інакше мені доведеться вважати, що тебе на івенті не буде.

Якщо ти у списку очікування кудись, то я швиденько порадую тебе новинами, якщо з'явиться вільне місце, але знову ж, тобі треба буде швидко (за п'ять хвилин) підтвердити свої наміри.
